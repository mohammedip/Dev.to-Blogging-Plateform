                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php  $articles=Article::getAllArticlesDraft();
                                       ...
                                       foreach($tags as $tag) {
                                        ...
                                        <td>' . $article['views'] . '</td>
                                        <td>
                                            <a href="../../classes/Article.php?function=draft&accepted=true&id=' . $article['articles_id'] . '" class="btn btn-primary btn-sm">Accepted</a>
                                            <a href="../../classes/Article.php?function=draft&accepted=false&id=' . $article['articles_id'] . '" class="btn btn-danger btn-sm">Refused</a>
