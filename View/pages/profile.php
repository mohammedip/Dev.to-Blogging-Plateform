            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="header-container d-flex justify-content-between align-items-center">
                        <h1 class="h3 mb-2 mt-4 text-gray-800">Profile</h1>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center">
                                    <img src="<?php echo $user['profile_picture_url']; ?>" width="200"class="img-fluid rounded-circle" alt="User Profile Picture">
                                </div>
